...
h3k4me1 <- Colname(read.delim("HistoneLiverH3k4me1MAdult8wks.bed", header = F, stringsAsFactors = F))
h3k4me3 <- Colname(read.delim("HistoneLiverH3k4me3MAdult8wks.bed", header = F, stringsAsFactors = F))
h3k9ac <- Colname(read.delim("HistoneLiverH3k09acMAdult8wks.bed", header = F, stringsAsFactors = F))
# h3k9me3 <- Colname(read.delim("", header = F, stringsAsFactors = F))
h3k27ac <- Colname(read.delim("HistoneLiverH3k27acMAdult8wks.bed", header = F, stringsAsFactors = F))
h3k27me3 <- Colname(read.delim("HistoneLiverH3k27me3MAdult8wks.bed", header = F, stringsAsFactors = F))
h3k36me3 <- Colname(read.delim("HistoneLiverH3k36me3MAdult8wks.bed", header = F, stringsAsFactors = F))
h3k79me2 <- Colname(read.delim("HistoneLiverH3k79me2MAdult8wks.bed", header = F, stringsAsFactors = F))
ctcf <- Colname(read.delim("TfbsLiverCtcfMAdult8wks.bed", header = F, stringsAsFactors = F))
pol2 <- Colname(read.delim("TfbsLiverPol2MAdult8wks.bed", header = F, stringsAsFactors = F))
...
liver.df <- data.frame(row.names = rownames(refgene.tx), rna.df[-idx, ],
...
liver.df[is.na(liver.df)] <- 0
save(marks.bi, liver.df, file = "~/Dropbox/Network/R1/liverDf.rdt")  # Liver
