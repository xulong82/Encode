...
#----------------------------------------------------------------------------------------------
library(ggplot2)
# source("~/Dropbox/Encode/R/encode.ch12.R")
...
marks.pm.bi <- refgene.pm.bi * ch12.marks.bi
marks.tx.bi <- refgene.tx.bi * ch12.marks.bi
marks.ex.bi <- refgene.ex.bi * ch12.marks.bi
marks.it.bi <- marks.tx.bi - marks.ex.bi
marks.ig.bi <- ch12.marks.bi - marks.tx.bi
#----------------------------------------------------------------------------------------------
marks.1 <- apply(ch12.marks.bi, 2, sum)  # coverage: number of 1
